                    ...
                    <td>
                        <div class="action-icons">
                            ...
                            <i class="bi bi-eye action-icon icon-view"
                               ...
                               onclick="showPartListing('{{ $p->nomor_permintaan }}', '{{ addslashes($p->jenis_produk) }}', {{ $p->permintaan_id }})">
                            </i>

                            {{-- Approve (hanya jika submitted) --}}
                            @if($p->status === 'submitted')
                            <form action="{{ route('admin.permintaan.approve', $p->permintaan_id) }}" method="POST" style="display:inline">
                                @csrf
                            ...
                            {{-- Hapus --}}
                            <form action="{{ route('admin.permintaan.destroy', $p->permintaan_id) }}" method="POST" style="display:inline">
                                @csrf
                                @method('DELETE')
