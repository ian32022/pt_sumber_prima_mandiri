...
<body>
    ...
    <div id="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="request.htmml"><i class="bi bi-file-earmark-text"></i> Request Management</a>
            <a class="nav-link" href="planing.html"><i class="bi bi-calendar-event"></i> Production Planning</a>
